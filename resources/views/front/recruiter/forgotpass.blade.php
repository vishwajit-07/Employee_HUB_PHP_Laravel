...
<body>
    ...
    <div class="container4">
        ...
        <form id="forgot-password-form" method="post" action="{{ route('recruiter.forgotpass') }}">
            @csrf
            <div class="form-group">
                <label for="email">Email:</label>
                <input type="text" id="email" name="email" value="{{ $recruiter->email }}" disabled>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.location.href = "{{ route('account.recruiterlogin') }}";
                        }
                    },
                    error: function(xhr) {
